...
#' @usage sfactor3Hedp_5p(ECM = ECM, ER = ER, gi = gi, gf = gf, r_i = r_i, r_f = r_f)
#' @format \describe{
#' \item{x}{
#' The function has 6  arguments: ECM, ER, gi, gf, r_i, r_f}
#' }
#' @param ECM ECM
#' @param ER  ER
#' @param gi  gi
...
sfactor3Hedp_5p <- function(ECM,ER,gi,gf, r_i = 6, r_f =5){
  # Constants
